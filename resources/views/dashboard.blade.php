        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-8">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <p class="mt-1 text-gray-500">Berikut adalah ringkasan data terbaru dari Sistem Informasi Perumahan Garut.</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-gradient-to-br from-blue-500 to-indigo-600 text-white overflow-hidden shadow-lg rounded-xl p-6 flex flex-col justify-between transform transition-all duration-300 hover:scale-105">
                    <div>
                        <svg class="h-10 w-10 opacity-70" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <div class="bg-gradient-to-br from-green-500 to-teal-600 text-white overflow-hidden shadow-lg rounded-xl p-6 flex flex-col justify-between transform transition-all duration-300 hover:scale-105">
                    <div>
                        <svg class="h-10 w-10 opacity-70" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                {{-- Card 3: Total Unit --}}
                <div class="bg-gradient-to-br from-yellow-500 to-orange-600 text-white overflow-hidden shadow-lg rounded-xl p-6 flex flex-col justify-between transform transition-all duration-300 hover:scale-105">
                    <div>
                        <svg class="h-10 w-10 opacity-70" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                {{-- Card 4: Unit Terjual --}}
                <div class="bg-gradient-to-br from-red-500 to-pink-600 text-white overflow-hidden shadow-lg rounded-xl p-6 flex flex-col justify-between transform transition-all duration-300 hover:scale-105">
                    <div>
                        <svg class="h-10 w-10 opacity-70" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">

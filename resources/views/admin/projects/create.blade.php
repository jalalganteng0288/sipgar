                ...
                <div class="bg-white p-8 rounded-lg shadow-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="developer_name" name="developer_name" type="text" class="mt-1 block w-full" :value="old('developer_name')" required />
                ...
                <div class="bg-white p-8 rounded-lg shadow-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="village_code" name="village_code" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" disabled>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                            <div>
                                ...
                                <x-text-input id="latitude" name="latitude" type="text" class="mt-1 block w-full bg-gray-100" :value="old('latitude', '-7.2278')" readonly/>
                            </div>
                            <div>
                                <x-input-label for="longitude" :value="__('Longitude')" />
                                <x-text-input id="longitude" name="longitude" type="text" class="mt-1 block w-full bg-gray-100" :value="old('longitude', '107.9087')" readonly/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-lg shadow-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <img id="image-preview" src="" alt="Image Preview" class="mt-4 rounded-md shadow-sm" style="display:none; max-height: 200px;">
                        </div>
                        <div>
                            ...
                            <input id="site_plan" name="site_plan" type="file" class="mt-1 block w-full" onchange="previewImage(event, 'site_plan-preview')">
                             <img id="site_plan-preview" src="" alt="Site Plan Preview" class="mt-4 rounded-md shadow-sm" style="display:none; max-height: 200px;">
                        </div>
                    </div>
                </div>

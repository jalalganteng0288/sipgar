    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-8 rounded-lg shadow-lg">
                <form action="{{ route('admin.projects.house-types.store', $project->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="land_area" name="land_area" type="number" class="mt-1 block w-full" :value="old('land_area')" required />
                        </div>
                        <div>
                            <x-input-label for="building_area" :value="__('Luas Bangunan (m²)')" />
                            <x-text-input id="building_area" name="building_area" type="number" class="mt-1 block w-full" :value="old('building_area')" required />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <x-text-input id="total_units" name="total_units" type="number" class="mt-1 block w-full" :value="old('total_units')" required />
                        </div>
                    ...
                    <div class="flex items-center justify-end gap-4 mt-8">
                        <a href="{{ route('admin.projects.show', $project->id) }}" class="text-gray-600 hover:underline">Batal</a>
